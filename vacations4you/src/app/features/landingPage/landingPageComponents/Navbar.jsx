...
import { NavButtons, NavLinks } from "./helper/DataList";
import { List } from "../landingPageComponents/customComponents/List";
    ...
    return (
        <header className="w-full h-auto bg-transparent overflow-x-hidden fixed z-50 top-0 left-0">
            <Slide direction="down">
                <nav className={`w-full md:h-32 h-28 ${navBarColor ? "bg-white" : "bg-transparent"} lg:px-24 md:px-12 px-8 flex justify-between items-center`}>
                    <Image as="a" href="/" className="md:h-32 h-28" image={Logo} alt="Logo" />
