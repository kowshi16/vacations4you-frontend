...
import { FooterTexts } from "../landingPageComponents/helper/DataList";
import { List } from "../landingPageComponents/customComponents/List";
import { Link } from "react-router-dom";
import { FacebookLogo, InstagramLogo, TwitterLogo } from "@phosphor-icons/react";
import app from "../../../../images/landingPage/appdownload.png";
                    ...
                    <ul className="flex flex-col gap-2">
                        {FooterTexts.quickLinks.links.map((link, index) => (
                            <List key={index} className="text-sm">
                                <Link to={link.url} className="text-color4 transition-all duration-300 hover:underline">
                                    {link.name}
                                </Link>
                            </List>
                        ))}
